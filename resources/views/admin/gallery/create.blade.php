            ...
            <div class="row page-titles mx-0">
                <div class="col-sm-6 p-md-0">
                    <div class="welcome-text">
                        <h4>Hi, {! User !}!</h4>
                        <p class="mb-0">Set the Gallery content on the school site</p>
                    </div>
                </div>
                                ...
                                <form enctype="multipart/form-data" action="{{ route('gallery.store') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control input-default " placeholder="Gallery Title"
                                            id="gallery_title" name="gallery_title">
                                    ...
                                    <div class="input-group  mb-3">
                                        ...
                                        @error('gallery_img') <span class="text-danger">{{ $message }}</span> @enderror
                                    </div>
